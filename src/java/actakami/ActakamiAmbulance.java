...
import actakami.target.ActakamiVictimSelector;
...
// import comlib.adk.util.target.sample.ActakamiVictimSelector;
import comlib.manager.MessageManager;

public class ActakamiAmbulance extends BasicAmbulance {
    ...
    public VictimSelector getVictimSelector() {
        if(this.victimSelector == null) {
            this.victimSelector = new ActakamiVictimSelector(this);
        }
